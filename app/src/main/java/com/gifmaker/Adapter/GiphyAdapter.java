 ...
 */
public class GiphyAdapter extends RecyclerView.Adapter<GiphyAdapter.Holder> {
    ...
    public GiphyAdapter(Context mContext, ArrayList<Data> mPictures) {
    ...
    @Override
    public GiphyAdapter.Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(mContext).inflate(R.layout.row_my_gif, parent, false));
    }

    @Override
    public void onBindViewHolder(GiphyAdapter.Holder holder, int position) {
